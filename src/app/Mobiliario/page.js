...
import { mobiliario } from "../../../components/data";

export const galeria = mobiliario
...
const page = () => {
  return (
    <section id="galery">
      ...
      <div className="grid">
        {mobiliario.map((galeria, index) => (
          <a key={galeria.id} href={`/Mobiliario-photo/${index}`} className="active">
